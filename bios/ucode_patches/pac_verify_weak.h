...
unsigned long ucode_patch[][4] = {
    ...
    // U7d20: tmp4 := XOR_DSZ64(tmp4, tmp3); tmp3 := ROL_DSZ64(tmp3, 0x20); tmp5 := XOR_DSZ64(tmp1, tmp2)
    {0x804600034cf4, 0x6c20033233, 0x804600035cb1, 0x300000c0},
    // U7d24: tmp5 := XOR_DSZ64(tmp5, tmp3); tmp5 := XOR_DSZ64(tmp5, tmp4); tmp5 := SHL_DSZ64(tmp5, 0x30)
    {0x804600035cf5, 0x4600035d35, 0xc06430035235, 0x300000c0},
    // U7d28: rax := XOR_DSZ64(tmp5, rax); NOP; NOP SEQW LFNCEWAIT, UEND0
