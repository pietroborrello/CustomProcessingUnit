...
unsigned long ucode_patch[][4] = {
    ...
    // U7c04: tmp0:= AND_DSZ64(0xffff, tmp0); tmp2:= LDPPHYS_DSZ8_ASZ64_SC1(tmp1, tmp0); tmp2:= ADD_DSZ64(0x1, tmp2)
    {0x4044ff7f0c0f, 0xeea00032c31, 0x804001032c88, 0x300000c0},
    // U7c08: STADPPHYS_DSZ8_ASZ64_SC1(tmp1, tmp0, tmp2); NOP; NOP SEQW LFNCEWAIT, UEND0
